let fs,mathjax,yargs;_fb5‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_fb5‍.w("mathjax-full",[["*",null,function(v){mathjax=v}]]);_fb5‍.w("yargs",[["default",["yargs"],function(v){yargs=v}]]);
...
try {
    ...
    _fb5‍.g.console.error('ERROR!', err);
}
