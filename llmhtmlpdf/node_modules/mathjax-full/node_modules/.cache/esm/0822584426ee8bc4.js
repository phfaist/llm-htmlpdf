...
const path = _26e‍.u(eval(_26e‍.c("require('path')")));  // use actual node version, not webpack's version
...
combineDefaults(MathJax.config, 'loader', {
  require: _26e‍.u(eval(_26e‍.c('require'))),      // use node's require() to load files
 ...
 */
const dir = CONFIG.paths.mathjax = _26e‍.u(eval(_26e‍.c('__dirname')));
